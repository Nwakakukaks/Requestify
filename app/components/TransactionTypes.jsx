    ...
    const checkRequestCompletion = async (requestClient, requestId) => {
      try {
        ...
        while (
          ...
          parseFloat(requestData.balance.balance) <
            parseFloat(requestData.expectedAmount)
        ) {
          ...
          requestsResponse.map(async (requestItem) => {
            ...
            try {
              ...
              return {
                ...
                contentData:
                  initialData.extensions["content-data"]?.values || {},
              ...
              console.error(
                `Error processing request ${initialData.requestId}:`,
                error
              );
              return null;
            }
      ...
      <div className="mt-16">
        <div className="container-parent">
          <div className="flex flex-col-reverse gap-6 md:gap-0 md:flex-row  items-center justify-between pb-0 md:pb-[24px] px-[24px]">
            <h1 className="reqheader2">All Contracts</h1>
            <Link
              href="/send-request"
